  ...
  return (
    <div>
      ...
      <div className="mb-3 text-muted">
        <small>{products.length} producto{products.length !== 1 ? 's' : ''} encontrado{products.length !== 1 ? 's' : ''}</small>
      </div>

      {products.length === 0 ? (
        <div className="alert alert-info">No se encontraron productos con los filtros seleccionados.</div>
      ) : (
